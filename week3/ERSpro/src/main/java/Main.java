...
public class Main{
    ...
    public static void managerLogin(){
        ...
        while(true) {
            ...
            System.out.println("6. View all reimbursement requests from an employee.");
    ...
    public static void registerEmp(){
        ...
        System.out.println("Welcome to employee registraion");
        System.out.println("Enter a username for the employee");
        Scanner sc = new Scanner(System.in);
        username = sc.next();
        System.out.println("Enter a Password");
        password = sc.next();
        ...
        Employee emp = new Employee(username, password, first, last);
        if(ERSService.insertEmp(emp)){
